...
5. **L0↔L1 cardinality invariant.** With this slice, the live catalog carries 49 PCs and 49 PGs in 1:1 cardinality. The CR-BP-100 L0L1-CARD-001 gate (open PR #141) will validate this end-to-end when it merges; this slice brings the catalog to the 49-cell state the validator requires.
